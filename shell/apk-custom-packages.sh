...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-hwmon-gpiofan luci-i18n-advanced-reboot-zh-cn luci-i18n-argon-config-zh-cn luci-i18n-autoreboot-zh-cn luci-i18n-base-zh-cn luci-i18n-cloudflared-zh-cn luci-i18n-ddns-go-zh-cn luci-i18n-diskman-zh-cn luci-i18n-filebrowser-go-zh-cn luci-i18n-filemanager-zh-cn luci-i18n-firewall-zh-cn luci-i18n-frpc-zh-cn luci-i18n-natmap-zh-cn luci-i18n-netdata-zh-cn luci-i18n-openvpn-zh-cn luci-i18n-package-manager-zh-cn luci-i18n-ramfree-zh-cn luci-i18n-samba4-zh-cn luci-i18n-timewol-zh-cn luci-i18n-ttyd-zh-cn luci-i18n-upnp-zh-cn luci-i18n-vlmcsd-zh-cn luci-i18n-wol-zh-cn luci-i18n-smartdns-zh-cn luci-i18n-samba4-zh-cn luci-i18n-cpufreq-zh-cn openssh-server zram-swap kmod-nft-fullcone 7z bsdtar unzip unrar zstd wget-ssl curl xz gzip tar -ntpd openssh-sftp-client openssh-sftp-server openssh-client-utils coremark luci-app-adguardhome luci-app-openclash kmod-usb-net kmod-usb-net-asix kmod-usb-net-asix-ax88179 kmod-usb-net-cdc-eem kmod-usb-net-cdc-ether kmod-usb-net-cdc-mbim kmod-usb-net-cdc-ncm kmod-usb-net-cdc-subset kmod-usb-net-rndis kmod-usb-net-huawei-cdc-ncm usb-modeswitch kmod-usb-serial kmod-usb-serial-ch341 kmod-usb-serial-ch348 kmod-usb-serial-cp210x kmod-usb-net-hso kmod-gpio-pwm kmod-usb-net-ipheth kmod-usb-net-kalmia kmod-usb-net-kaweth kmod-usb-net-lan78xx kmod-usb-net-mcs7830 kmod-usb-net-pegasus kmod-usb-net-pl kmod-usb-net-qmi-wwan kmod-usb-net-qmi-wwan-fibocom kmod-usb-net-qmi-wwan-quectel kmod-usb-net-rtl8150 kmod-usb-net-sierrawireless kmod-usb-net-smsc75xx kmod-usb-net-smsc95xx kmod-zram kmod-mii kmod-fs-exfat kmod-fs-vfat kmod-fs-ntfs3 kmod-fs-ext4 kmod-fs-xfs kmod-fs-squashfs kmod-lib-lz4 kmod-lib-lzo kmod-lib-zstd kmod-mtd-rw luci-nginx nano-full vim-fuller atop htop btop bash zsh zoneinfo-all rsync aria2-openssl adb ethtool-full fdisk cfdisk btrfs-progs usbutils"
